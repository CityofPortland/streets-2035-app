    ...
    <header>
      <figure class="prose max-w-none">
        ...
        <figcaption class="italic px-4">
          ...
          with colors that represent who is responsible for each area or item.
        </figcaption>
      </figure>
    </header>
          ...
          <li>
            <p>
              <router-link to="/street-types" v-slot="{ href, navigate }"
                ...
                ></router-link
              >
              identify general design priorities and considerations for
              different types of streets. The role that each street plays in the
              city is related to its transportation function and the adjacent
              land use context. The functional needs of a given street type
              informs decision-making with both private development and capital
              projects.
            </p>
          </li>
          <li>
            <p>
              <router-link to="/public-improvements" v-slot="{ href, navigate }"
                ...
                ></router-link
              >
              allows users to visualize the different standards that may apply
              to their development project, with links to available deviation
              processes and a more detailed page of city standards, guidelines
              and requirements that impact space in right-of-way.
            </p>
          </li>
          <li>
            <p>
