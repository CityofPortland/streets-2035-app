  ...
  <article class="max-w-7xl px-4 mx-auto">
    ...
    <main class="prose">
      ...
      <p>
        ...
        classifications, width, and the typical cross section(s) associated with
        it.
      </p>
      ...
      <p>
        ...
        the various ways that the street cross-section could be laid out and are
        available for the eight most common roadway widths in Portland.
      </p>

      <p>
        Typical sections can be accessed from the curb-to-curb width drop-down
        menu on the [insert title] page or by selecting a specific road segment
        from the map. Select the "Option" link below each section to launch a
        new page with "episodic" cross sections that illustrate elements not
        needed continuously throughout a corridor (such as left turn lanes,
        pedestrian crossings, or transit priority lanes) and help visualize
        where the space for these elements comes from.
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            dimensions due to space constraints. “Balanced” cross-sections need
            to be evaluated to determine if the compromises to the accommodation
            of each mode are acceptable.
          </p>
        </li>
        <li>
          <p>
            ...
            require a different accommodation for one or more right-of-way uses,
            such as providing travel for a particular mode on a parallel route.
          </p>
        </li>
      </ul>
      ...
      <p>
        ...
        design. Staff may develop new cross sections to complement the existing
        typical sections or when typical sections are not available for a given
        street width. This could include adapting a cross section from a
        narrower street width. Staff would then apply the framework for working
        through trade-offs.
      </p>
      <h2>
      ...
      <p>
        ...
        visualization of the potential trade-offs for each cross-section option.
        The visualization is generated based on the street type, the width of
        the street, and the modal priorities identified for the street in the
        Transportation System Plan (TSP). The priority drop-down boxes at the
        top of the page reflect the TSP designations of the particular street
        segment selected from the map.
      </p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            corridor, whether as a pedestrian or by bicycle, transit, freight or
            motor vehicle.
          </p>
        </li>
        <li>
          <p>
            <strong>Access</strong> evaluates the ability to access destinations
            on the corridor, including the ability to safely cross the street,
            reach destinations by bicycle, access the curb at transit stops, and
            to serve loading and parking needs.
          </p>
        </li>
      </ul>
      <p>The color-coding highlights where trade-offs need to be considered:</p>
      <ul>
        <li>
        ...
        <li>
          Yellow cells: mean that the mode or use is supported but with minimum
          or less than preferred dimensions. These trade-offs need to be further
          analyzed to determine if they are acceptable and/or if they can be
          mitigated through project design (see "Analytical Considerations"
          section below).
        </li>
        <li>
          Red cells: mean that the mode or use is not accommodated, and,
          depending on the policy designations of the street, this may be deemed
          an “alternative” cross-section. Decisions to not accommodate a mode or
          use that is established in policy need to be justified (see
          "Justification of Alternative" section below).
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        tradeoffs between cross-sections. This process is intended to help staff
      ...
      <ul>
        <li>
          ...
          considered and refer to the “Analysis of Tradeoffs” column to identify
          analyses that inform whether a tradeoff is acceptable. These analyses
          may identify that the tradeoff is of minimal impact or can be
        ...
        <li>
          ...
          achieving a balanced cross section. This step also supports consistent
          documentation when a constraint cannot be overcome.
        </li>
        <li>
      ...
      <p>
        ...
        cross-section that does not meet an applicable adopted policy (e.g., if
        a decision is made to not serve a mode designated in the TSP
        classifications).
      </p>
      <figure>
