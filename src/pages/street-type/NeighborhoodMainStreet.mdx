...
<section class="mt-8 prose">
    <FieldList class="gap-4">
        ...
        <Field name="Greening">
            Street trees are located in tree wells to enhance the public realm adjacent to destinations. Where space allows and safe sight lines can be maintained, median refuge islands may also be planted.
