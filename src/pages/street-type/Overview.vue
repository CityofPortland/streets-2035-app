<template>
  <article>
    <header class="mb-4">
      <h1 class="text-4xl font-bold mb-12">Street types overview</h1>
      <Box
        color="gray"
        variant="light"
        class="
    ...
    <main class="prose">
      ...
      <p>
        ...
        Cronut franzen affogato brunch shaman. Lumbersexual humblebrag narwhal
        affogato bespoke iceland. Lyft ethical tumblr pinterest marfa viral.
      </p>
      <p>
        ...
        vegan. Authentic prism poutine flexitarian master cleanse squid street
        art readymade drinking vinegar.
      </p>
      <p>
        ...
        tilde chambray food truck woke. Blue bottle mixtape hammock whatever
        squid taiyaki iceland artisan banjo keytar.
      </p>
    </main>
  </article>
</template>
